...
export const noButtonMessages = [
  "Plssss noooo cutieeee 😭",
  "My heart is breaking 💔 say yesss naaa",
  "I'll cry forever if you say noooo 🥺",
  "You love me I know it 😤💖",
  "Noooo baby pleaseeee 😭😭",
  "I'm literally crying rn 🥺💔",
  "Are you seriousss?? Say yessss 😤",
  "My heart cannot take this 💔😢",
  "You're being so mean 😭 say yes already",
  "I know you wanna say yes 😏💖",
  "Pleaseeee my love 🥺🥺🥺",
  "I'll never stop asking 😤💕",
  "You know I'm the best option 😎💖",
  "My world is falling apart 😭",
  "Baby pleaseeeee I need youuu 🥺",
  "I'm on my knees begging 🧎💖",
  "You can't do this to meee 😭💔",
  "I promise infinite cuddles if you say yes 🤗💖",
  "Your heart is saying yes I can hear it 💓",
  "Don't break my little heart 🥺💔",
  "I'll cook for you forever if you say yes 👨‍🍳💖",
  "Nooooo not the NO button 😱💔",
  "Fine I'll just love you anyway 😤💕",
  "Every NO makes me love you MORE 💖",
  "I refuse to accept this 😭",
  "My tears could fill an ocean rn 🌊😢",
  "You love me more than anything admit it 😏",
  "Say yes or I'm telling your mom 😤",
  "I'm literally the cutest person ever say yes 🥺",
  "This is breaking my heart into tiny pieces 💔",
  "I will haunt your dreams until you say yes 👻💖",
  "Babe pleaseeeee 😭😭😭😭",
  "I can't breathe without your yes 😢💨",
  "My love for you is bigger than this NO 💖",
  "You're torturing me and I still love you 😭💕",
  "PLEASEEEEE I'M BEGGING 🙏💖",
  "I know you clicked NO by accident right?? 😏",
  "Your finger slipped... right?? 🥺",
  "The NO button is broken don't click it 😤",
  "I can see you smiling say YESSS 😊💖",
  "One more NO and I'll send 1000 love texts 📱💕",
  "You're the cutest human ever say yes to me 🥺",
  "I'll write you love letters every day 💌",
  "My cat says you should say yes too 🐱💖",
  "I promise to always share my food with you 🍕💕",
  "You complete me like WiFi to my phone 📶💖",
  "I love you to the moon and back 🌙💕",
  "Saaaay yesssss alreadyyyy 😩💖",
  "I'll give you all the blanket I promise 🛏️💕",
  "Every star in the sky says yes ⭐💖",
];
...
export const sweetMessages = [
  ...
  "You make my heart do that thing where it goes 💓💓💓",
  "Being with you feels like coming home 🏠💕",
  "You're the plot twist I never saw coming 📖💖",
  "My favorite place in the world is next to you 🤗",
  "You're the WiFi to my internet — I can't function without you 📶💕",
...
export const quizQuestions = [
  ...
  {
    question: "Who's the cutest in this relationship? 🥰",
    options: [
      { text: "Obviously ME!", result: "True but you still love me more 😏" },
      { text: "Both of us!", result: "Fair point but you love me MORE 💖" },
      { text: "My partner!", result: "Aww thanks but YOU love ME more 😘" },
    ],
  },
  {
    question: "What would you do without me? 🤔",
    options: [
      { text: "I'd be totally fine 😎", result: "LIAR you'd miss me so much 😭💖" },
      { text: "I'd be lost 🥺", result: "I KNEW IT you love me more!! 😏💕" },
      { text: "I'd adopt 10 cats 🐱", result: "Haha but you'd still love me most 💖" },
    ],
  },
];
...
export const themeDescriptions = {
  movie: {
    name: "Movie Theme",
    subtitle: "5 Feet Apart Inspired",
    description: "Emotional soft tones, rain/glass blur effect, cinematic text",
    emoji: "🎬",
    colors: { bg: "from-slate-900 to-blue-950", accent: "text-blue-300" },
  },
  music: {
    name: "Romantic Music",
    subtitle: "Falling In Love With You",
    description: "Vinyl record animation, floating music notes, warm sunset colors",
    emoji: "🎵",
  ...
  spicy: {
    ...
    description: "Dark red + pink neon glow, playful hearts, flirty text style",
    emoji: "🔥",
    colors: { bg: "from-red-950 to-pink-950", accent: "text-pink-400" },
  },
  cute: {
    name: "Cute & Playful",
    subtitle: "Childish Teasing",
    description: "Pastel colors, bouncing buttons, doodle hearts, playful emojis",
    emoji: "🧸",
